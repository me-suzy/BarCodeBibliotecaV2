...
$config_email = [
    ...
    'smtp_port' => 587,
    'smtp_user' => 'biblioteca@example.com', // SCHIMBĂ CU EMAIL-UL TĂU
    'smtp_pass' => 'parola_aplicatie',       // SCHIMBĂ CU PAROLA
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    if ($_POST['action'] === 'save_config') {
        ...
        $mesaj_email = "Acesta este un email de test din sistemul bibliotecii.";
        
        // Trimite email de test
        $headers = "From: " . $config_email['from_name'] . " <" . $config_email['from_email'] . ">\r\n";
        $headers .= "Content-Type: text/html; charset=UTF-8\r\n";
        
        if (mail($email_test, $subiect, $mesaj_email, $headers)) {
            $mesaj = "✅ Email de test trimis cu succes la: $email_test";
            $tip_mesaj = "success";
        } else {
            $mesaj = "❌ Eroare la trimiterea emailului. Verifică configurația SMTP.";
            $tip_mesaj = "danger";
        }
    }
}
            ...
            <div class="test-section">
                ...
                <form method="POST" style="margin-top: 15px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email_test" placeholder="test@example.com" required>
                    </div>
                    <button type="submit" class="btn-primary">📧 Trimite Email de Test</button>
                </form>
            </div>
        </div>
